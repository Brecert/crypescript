...
class Crypescript::Command
  USAGE = <<-USAGE
  Usage: crype [command] [switches] [program file] [--] [arguments]
  Command:
      init                     generate a new project
      transpile                transpile crystal code to typescript code
